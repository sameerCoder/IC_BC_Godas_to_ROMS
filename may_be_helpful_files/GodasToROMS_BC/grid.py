...
#        gridid_file =  os.getenv("PYROMS_GRIDID_FILE")
       # gridid_file =  os.getenv("/home/sakib/Desktop/own_download_pyroms/pyroms/examples/Arctic_HYCOM_GLBy/gridid.txt")
       # gridid_file="gridid.txt"
    ...
    #    info = []
     ...
     #           if s[2] == self.id:
      ...
      #              for l in range(line_nb, line_nb+3):
      #                  s1 = lines[l].split()
       #                 print("ss:",s1)
       #                 #info.append(s1)
        #                print("info 1st:",info)
        #                line_nb = line_nb + 1
                    ...
                    #below code written by msa
                    #for l in range(line_nb,line_nb+5):
                         # print("l:")
         #           for j in info:
         #             if  'roms' in j:
         #               print("roms inside info")
      ...
      #      pass
        ...
        print("b4 compare info:",info2)
        info2.insert(4,'roms')
        info=[i for i in range(20)]
        if info2[4] == 'roms':
            self.name     ='GODASROMS'
            self.grdfile  ='/home/sakib/Desktop/own_download_pyroms/pyroms/examples/Arctic_HYCOM_GLBy/roms_grd_1x12.nc'
            self.N        =40
            self.grdtype  ='roms'
            self.Vtrans   =4
            self.theta_s  =7
