...
def remap_bdry_uv(src_file, src_grd, dst_grd, dxy=20, cdepth=0, kk=2, dst_dir='./'):
    ...
    ncu.createVariable('u_north', 'f8', ('time', 's_rho', 'xi_u'), fill_value=spval)
    ...
    ncu.createVariable('u_south', 'f8', ('time', 's_rho', 'xi_u'), fill_value=spval)
    ...
    ncu.createVariable('u_east', 'f8', ('time', 's_rho', 'eta_u'), fill_value=spval)
    ...
    ncu.createVariable('u_west', 'f8', ('time', 's_rho', 'eta_u'), fill_value=spval)
    ...
    ncu.createVariable('ubar_north', 'f8', ('time', 'xi_u'), fill_value=spval)
    ...
    ncu.createVariable('ubar_south', 'f8', ('time', 'xi_u'), fill_value=spval)
    ...
    ncu.createVariable('ubar_east', 'f8', ('time', 'eta_u'), fill_value=spval)
    ...
    ncu.createVariable('ubar_west', 'f8', ('time', 'eta_u'), fill_value=spval)
    ...
    ncv.createVariable('v_north', 'f8', ('time', 's_rho', 'xi_v'), fill_value=spval)
    ...
    ncv.createVariable('v_south', 'f8', ('time', 's_rho', 'xi_v'), fill_value=spval)
    ...
    ncv.createVariable('v_east', 'f8', ('time', 's_rho', 'eta_v'), fill_value=spval)
    ...
    ncv.createVariable('v_west', 'f8', ('time', 's_rho', 'eta_v'), fill_value=spval)
    ...
    ncv.createVariable('vbar_north', 'f8', ('time', 'xi_v'), fill_value=spval)
    ...
    ncv.createVariable('vbar_south', 'f8', ('time', 'xi_v'), fill_value=spval)
    ...
    ncv.createVariable('vbar_east', 'f8', ('time', 'eta_v'), fill_value=spval)
    ...
    ncv.createVariable('vbar_west', 'f8', ('time', 'eta_v'), fill_value=spval)
